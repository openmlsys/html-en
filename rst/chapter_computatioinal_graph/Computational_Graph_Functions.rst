...
.. figure:: ../img/ch04/graph.png

   Computational graph–basedarchitecture
...
3. **Lifetime analysis of model variables.** During model training, many
   ...
   helping the framework optimize memory management.
...
4. **Execution optimization.** User programs can have different network
   ...
   strategies to improve the model execution efficiency.
