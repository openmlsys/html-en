...
GPT-3 (175B) in 2020; PanGu (100B), PanGu-\ :math:`\alpha` (200B),
Google’s Switch Transformer (1.6T), and WuDao (1.75T) in 2021; along
with Facebook’s NLLB-200 (54B) in 2022. The demand for ultra-large model
...
Functorch introduces *vmap*, standing for "vectorized map". Its role is
to adapt functions designed for individual inputs so that they can
...
(specifying the :math:`out\_dim` argument), a contrast to the default
