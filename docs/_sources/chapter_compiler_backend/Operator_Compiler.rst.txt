...
.. figure:: ../img/ch05/memory_architecture.png
...
.. figure:: ../img/ch05/parallel_computing.png
...
In Code ``lst:before_tvm``, the basic computational logic is as follows:
...
``lst:after_tvm``. We perform tiling on loops m and n based on factor 32
as the previous analysis. Similarly, we tile the loop k based on factor
4, then reorder the k.outer and k.inner axis as the outermost axis.
