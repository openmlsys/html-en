...
.. table:: Physics Simulation Libraries and Environments
   ...
   | * |           |                                                       |
   +===+===========+=======================================================+
   | 2 | MuJoCo [@ | MuJoCo offers a unique combination of speed, accuracy |
   | 0 | todorov20 | and modeling power, designed from the ground up for   |
   | 1 | 12mujoco] | model-based optimization and optimization through     |
   | 2 |           | contacts.                                             |
   +---+-----------+-------------------------------------------------------+
   | 2 | PyBullet  | PyBullet is an easy to use Python module for physics  |
   | 0 | [@coumans | simulation, robotics and deep reinforcement learning  |
   | 1 | 2016pybul | based on the Bullet Physics SDK.                      |
   | 6 | let]      |                                                       |
   +---+-----------+-------------------------------------------------------+
   | 2 | Unreal    | Unreal CV provides functions for perception,          |
   | 0 | CV [@qiu2 | navigation, physical simulations, and learning and    |
   | 1 | 016unreal | evaluation of algorithms.                             |
   | 6 | cv]       |                                                       |
   +---+-----------+-------------------------------------------------------+
   | 2 | DeepMind  | DeepMind Lab is a first-person 3D game platform       |
   | 0 | Lab [@bea | designed for research and development of general      |
   | 1 | ttie2016d | artificial intelligence and machine learning systems. |
   | 6 | eepmind]  |                                                       |
   +---+-----------+-------------------------------------------------------+
   | 2 | Habitat [ | Habitat-Sim is a flexible, high-performance 3D        |
   | 0 | @beattie2 | simulator with configurable agents, sensors, and      |
   | 1 | 016deepmi | generic 3D dataset handling.                          |
   | 6 | nd]       |                                                       |
   +---+-----------+-------------------------------------------------------+
   | 2 | AI2-THOR  | AI2-THOR consists of near photo-realistic 3D indoor   |
   | 0 | [@kolve20 | scenes, enabling research in various domains          |
   | 1 | 17ai2]    | including deep reinforcement learning and visual      |
   | 7 |           | question answering.                                   |
   +---+-----------+-------------------------------------------------------+
   | 2 | CHALET [@ | CHALET includes rooms and house configurations for    |
   | 0 | yan2018ch | training and evaluating autonomous agents in a        |
   | 1 | alet]     | challenging dynamic environment.                      |
   | 8 |           |                                                       |
   +---+-----------+-------------------------------------------------------+
   | 2 | VirtualHo | VirtualHome simulator allows the creation of a large  |
   | 0 | me [@puig | activity video dataset with rich ground-truth,        |
   | 1 | 2018virtu | enabling training and testing of video understanding  |
   | 8 | alhome]   | models.                                               |
   +---+-----------+-------------------------------------------------------+
   | 2 | VRKitchen | VRKitchen enables embodied agents to perform complex  |
   | 0 |  [@gao201 | tasks involving fine-grained object manipulations in  |
   | 1 | 9vrkitche | a realistic environment, and supports learning from   |
   | 9 | n]        | demonstration.                                        |
   +---+-----------+-------------------------------------------------------+
   | 2 | SAPIEN [@ | SAPIEN is a realistic and physics-rich simulated      |
   | 0 | xiang2020 | environment that hosts a large-scale set of           |
   | 2 | sapien]   | articulated objects, enabling various robotic vision  |
   | 0 |           | and interaction tasks.                                |
   +---+-----------+-------------------------------------------------------+
   | 2 | ThreeDWor | ThreeDWorld is a platform for interactive multi-modal |
   | 0 | ld [@gan2 | physical simulation, supporting real-time             |
   | 2 | 020threed | near-photo-realistic image rendering, high-fidelity   |
   | 0 | world]    | audio rendering, and more.                            |
   +---+-----------+-------------------------------------------------------+
   | 2 | Brax [@fr | Brax is an open-source library for rigid body         |
   | 0 | eeman2021 | simulation with a focus on performance and            |
   | 2 | brax]     | parallelism on accelerators, written in JAX.          |
   | 1 |           |                                                       |
   +---+-----------+-------------------------------------------------------+
   | 2 | iGibson2. | iGibson 2.0 supports object states, predicate logic   |
   | 0 | 0 [@li202 | functions, and can sample valid physical states based |
   | 2 | 1igibson] | on logic states.                                      |
   | 1 |           |                                                       |
   +---+-----------+-------------------------------------------------------+
   | 2 | Issac     | Isaac Gym offers a high performance learning platform |
   | 0 | Gym [@mak | to train policies for a wide variety of robotics      |
   | 2 | oviychuk2 | tasks directly on GPU.                                |
   | 1 | 021isaac] |                                                       |
   +---+-----------+-------------------------------------------------------+


As shown in Table :numref:\ ``simulations``, there are several simulator
...
.. figure:: ../img/ch13/affordance.pdf
...
.. _learning-directly-in-real-environments:
...
.. _sim2real-and-real-world-feedback:
...
.. _learning-from-real-world-demonstrations:
